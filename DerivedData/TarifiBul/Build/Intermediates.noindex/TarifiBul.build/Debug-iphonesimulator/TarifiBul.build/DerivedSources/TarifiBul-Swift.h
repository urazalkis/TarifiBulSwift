...
#ifndef TARIFIBUL_SWIFT_H
#define TARIFIBUL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TarifiBul",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9TarifiBul11AppDelegate")
...
SWIFT_CLASS("_TtC9TarifiBul14CircularButton")
...
SWIFT_CLASS("_TtC9TarifiBul10ErrorAlert")
...
SWIFT_CLASS("_TtC9TarifiBul13LoadingButton")
...
SWIFT_CLASS("_TtC9TarifiBul19LoginViewController")
@interface LoginViewController : UIViewController
- (void)loginButtonTapped;
- (void)newAccountButtonTapped;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9TarifiBul13SceneDelegate")
...
SWIFT_CLASS("_TtC9TarifiBul20SignInViewController")
...
SWIFT_CLASS("_TtC9TarifiBul20SignUpViewController")
...
SWIFT_CLASS("_TtC9TarifiBul13UserTextField")
@interface UserTextField : StandardTextField
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
